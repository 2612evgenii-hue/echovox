...
const items = [
  {
    title: 'Техника без давления',
    body: 'Опора, дыхание, связки — спокойно и понятно, без «ломания» голоса.',
    icon: Waves,
  ...
  {
    title: 'Сцена в крови',
    body: 'Подача, микрофон, уверенность — как вживую, так и в записи.',
    icon: Mic2,
    className: 'md:col-span-1',
    img: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=900&q=80',
  },
  {
    title: 'Звук премиум-класса',
    body: 'Слышим мелочи: тембр, атака, мягкость — и доводим до «дорого».',
    icon: Headphones,
    className: 'md:col-span-1',
  ...
  },
  {
    ...
    body: 'Поп, рок, соул, академия — выбираем материал под задачу и голос.',
    icon: Radio,
    className: 'md:col-span-1',
  ...
  },
  {
    ...
    body: 'Готовим к выступлениям: программа, образ, сценическая хватка.',
    icon: Trophy,
    className: 'md:col-span-1',
  ...
  },
  {
    ...
    body: 'Тёмный неон, фокус, тишина между нотами — как в настоящей студии.',
    icon: Stars,
    className: 'md:col-span-2',
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          ...
          <p className="mt-4 max-w-2xl text-base text-zinc-400 sm:text-lg">
            Не шаблонные «уроки ради уроков» — а дорожная карта: от первых нот
            до уверенного звучания в микрофоне.
          </p>
        </Reveal>
